          ...
          <div class="uk-overflow-auto">
            <table class="uk-table uk-table-middle uk-table-divider uk-table-small">
              ...
              <tbody>
                ...
                <?php foreach($newsList as $newsfr): ?>
                <tr>
                  <td><?= $newsfr->title ?></td>
                  <td><?= date('Y-m-d', $newsfr->date); ?></td>
                  <td>
                    <div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
                      <a href="<?= base_url('admin/news/edit/'.$newsfr->id); ?>" class="uk-button uk-button-primary uk-margin-small-right"><i class="fas fa-edit"></i></a>
                      <button class="uk-button uk-button-danger" value="<?= $newsfr->id ?>" id="button_delete<?= $newsfr->id ?>" onclick="DeleteNews(event, this.value)"><i class="fas fa-trash-alt"></i></button>
                    </div>
                  </td>
                </tr>
                <?php endforeach; ?>
    ...
    <script>
      function DeleteNews(e, value) {
        ...
        $.ajax({
          url:"<?= base_url($lang.'/admin/news/delete'); ?>",
          method:"POST",
          data:{value},
          dataType:"text",
          beforeSend: function(){
