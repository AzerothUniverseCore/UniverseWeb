...
class Admin_model extends CI_Model {
    ...
    {
        return $this->db->select('id')->get('newsfr')->num_rows();
    }
    ...
    {
        $this->db->where('id', $id)->delete('newsfr');
        return true;
    }
    ...
    {
        return $this->db->select('*')->limit($this->_pageNumber, $this->_offset)->get('newsfr')->result();
    }

    public function getNewsSpecifyRows($id)
    {
        return $this->db->select('*')->where('id', $id)->get('newsfr')->num_rows();
    }

    public function getNewIDperDate($date)
    {
        return $this->db->select('id')->where('date', $date)->get('newsfr')->row('id');
    }
    ...
    {
        return $this->db->select('*')->where('main', '2')->where('father', '0')->get('store_categoriesfr');
    ...
    public function insertStoreCategory($name, $route, $realmid, $main, $father)
    {
        if(!$this->StoreCategoryCheckRoute($route))
        {
            ...
            $this->db->insert('store_categoriesfr', $data);
            return true;
        }
        else
            return 'Rouerr';
    ...
    public function updateSpecifyStoreCategory($idlink, $name, $route, $realmid)
    {
        if(!$this->StoreCategoryCheckRoute($route))
        {
            ...
            $this->db->where('id', $idlink)->update('store_categoriesfr', $update);
            return true;
        }
        else
            return 'Rouerr';
    ...
    {
        $qq = $this->db->select('route')->where('route', $route)->get('store_categoriesfr')->row('route');
    ...
    {
        $this->db->where('id', $id)->delete('store_categoriesfr');
        return true;
    }

    public function countStoreCategories()
    {
        $this->db->from('store_categoriesfr');
        return $this->db->count_all_results();
    }

    public function storeCategoryList()
    {
        return $this->db->select('*')->limit($this->_pageNumber, $this->_offset)->get('store_categoriesfr')->result();
    }

    public function getCategoryStore()
    {
        return $this->db->select('*')->get('store_categoriesfr');
    }

    public function getStoreCategorySpecifyRows($id)
    {
        return $this->db->select('*')->where('id', $id)->get('store_categoriesfr')->num_rows();
    }

    public function getStoreCategoryName($id)
    {
        return $this->db->select('name')->where('id', $id)->get('store_categoriesfr')->row('name');
    }
    ...
    {
        return $this->db->select('realmid')->where('id', $id)->get('store_categoriesfr')->row('realmid');
    }
    ...
    public function insertItem($name, $description, $category, $type, $price_type, $pricedp, $pricevp, $icon, $command)
    {
        ...
        $this->db->insert('store_itemsfr', $data);
        return true;
    }
    ...
    public function updateSpecifyItem($id, $name, $description, $category, $type, $price_type, $pricedp, $pricevp, $icon, $command)
    {
        ...
        $this->db->where('id', $id)->update('store_itemsfr', $update);
        return true;
    }

    public function delStoreItem($id)
    {
        $this->db->where('id', $id)->delete('store_itemsfr');
    ...
    {
        $this->db->from('store_itemsfr');
        return $this->db->count_all_results();
    }

    public function storeItemList()
    {
        return $this->db->select('*')->limit($this->_pageNumber, $this->_offset)->get('store_itemsfr')->result();
    }

    public function getStoreItems()
    {
        return $this->db->select('*')->order_by('id', 'ASC')->get('store_itemsfr')->result();
    }
