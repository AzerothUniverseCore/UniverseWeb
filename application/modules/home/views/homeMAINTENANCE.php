<section class="syphrena-hero">
    <div class="syphrena-hero-container">
      ...
      <div class="syphrena-hero-subtitle" id="message">
        Les services sont temporairement indisponibles pour améliorer la qualité de Syphrena.
      </div>
      <div class="syphrena-hero-buttons">
        <a href="https://dev.syphrena.eu/frFR/index.php" target="_blank" class="syphrena-hero-button">
          <div class="syphrena-hero-button-inner">
            🏹 SUIVRE LA PROGRESSION DE SYPHRENA
          </div>
        </a>
      </div>
    </div>
  ...
  <script>
    const messages = [
      "Les services sont temporairement indisponibles pour améliorer la qualité de Syphrena.",
      "Vous pouvez suivre la progression de Syphrena en cliquant sur le bouton ci-dessous."
    ];
