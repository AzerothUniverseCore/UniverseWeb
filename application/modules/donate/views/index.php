        ...
        <div class="uk-grid uk-grid-medium" data-uk-grid>
          <div class="uk-width-1-4@m">
            <ul class="uk-nav uk-nav-default myaccount-nav">
              ...
              <li class="uk-active"><a href="<?= site_url('donate'); ?>"><i class="fas fa-hand-holding-usd"></i> <?=$this->lang->line('navbar_donate_panel'); ?></a></li>
              <?php endif; ?>
              ...
              <div>
                <div class="uk-transition-toggle" tabindex="0">
                  <div class="uk-card uk-card-body uk-card-donate uk-text-center uk-transition-scale-up uk-transition-opaque">
                    ...
                    <h5 class="uk-margin-small"><span uk-icon="icon: plus-circle"></span> <?= $this->lang->line('donate_get'); ?> <span class="uk-text-bold"><?= $donateList->pointsr ?></span> <?= $this->lang->line('panel_dp'); ?>
                    </h5>
